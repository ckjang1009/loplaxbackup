...
\- **테스트 모드**: 캠페인 장소 무제한 발송 기능. 세그먼트 광고ID 추가시 테스트 모드 버튼이 활성화 되며, 평상시는 비활성화 되어 있습니다. &#x20;

\- **1일 1회** : 캠페인 기간 동안 설정 장소에 방문을 여러번 해도 ‘하루에 한번’ 메시지 발송&#x20;

\- **기간 내 1회만** : 캠페인 기간 동안 ‘단 한번’ 메시지 발송&#x20;

\- **발송 후 00시간 00분 경과 후 재발송 활성화:** 방문한 장소에 머물러 있는 동안 ‘00시간 경과 후’ 메시지 재발송 활성화
